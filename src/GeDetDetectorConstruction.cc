...
G4VPhysicalVolume* GeDetDetectorConstruction::Construct()
{
 ...
 //Steel
  ...
  G4Element* Fe = new G4Element("Iron"  , "Fe", z=26., a= 55.845 *CLHEP::g/CLHEP::mole);
  
  G4Material* Steel = new G4Material("Steel", density= 7.81 *CLHEP::g/CLHEP::cm3, nel=2);
  Steel->AddElement(Fe, 99*CLHEP::perCent);
  Steel->AddElement(C, 1*CLHEP::perCent);
 ...
 //Air
  ...
  G4Material* Germanium = new G4Material("Germanium",				//its name
					 z=32, 				//atomic number
					 a= 72.64 *CLHEP::g/CLHEP::mole,					//mass of mole
					 density = 5.323*CLHEP::g/CLHEP::cm3, 				//density
					 kStateSolid,	//solid,gas
					 temperature = 77. *CLHEP::kelvin,	//temperature
					 pressure = 1 *CLHEP::atmosphere);		//pressure
...
//     new G4Material("Germanium", z= 32., a= 72.64*g/mole, density= 5.323*g/cm3);
  ...
  G4Material* Beryllium = 
    new G4Material("Beryllium", z= 4., a=9.012*CLHEP::g/CLHEP::mole, density=1.85 *CLHEP::g/CLHEP::cm3);
  
  //Silicon
  G4Material* Silicon = 
    new G4Material("Silicon", z= 14., a=28.086*CLHEP::g/CLHEP::mole,density=2.3296 *CLHEP::g/CLHEP::cm3);
...
//     new G4Material("Ceramic", z= 50., a=100.086*g/mole,density=10.3296 *g/cm3);
  ...
  temperature = 77.*CLHEP::kelvin;
  G4Material* Galactic = 
    new G4Material("Galactic", z=1., a=1.01*CLHEP::g/CLHEP::mole, density,
  ...
  G4double HalfWorldLength = 200*CLHEP::mm;
  ...
  G4double frontSiHeight = 0.15 *CLHEP::mm;
  G4double frontAirHeight = 12.5*CLHEP::mm; 
  G4double backSiHeight = 0.15 *CLHEP::mm;
  G4double backAirHeight = 1.*CLHEP::mm;
  G4double BeHeight = 0.0625 *CLHEP::mm;
  G4double tube1Height = 7.7 *CLHEP::mm;
  G4double tube2Height = 7.65 *CLHEP::mm;
  G4double tube3Height = 10.05 *CLHEP::mm; 
  G4double tube4Height = 10.05 *CLHEP::mm;
  G4double tube5Height = 10.05 *CLHEP::mm;
  G4double tube6Height = 10.15 *CLHEP::mm;
  G4double space = 2. *CLHEP::mm;

  G4double innerCaseHeight = 111.025 *CLHEP::mm;
  G4double outerCaseHeight = 127.3 *CLHEP::mm;
  
  G4double det1XRot = 0. *CLHEP::deg;
 G4double det2XRot = 60. *CLHEP::deg;
 G4double det3XRot = 120. *CLHEP::deg;
 G4double det4XRot = 180. *CLHEP::deg;
 G4double det5XRot = 240. *CLHEP::deg;


 G4double DetHeight =2*(tube6Height+ tube5Height + tube4Height + tube3Height  + tube2Height + tube1Height + BeHeight + backSiHeight + frontSiHeight) + (43 *CLHEP::mm);
  ...
  G4double outerCase_x = 0. *CLHEP::mm;
  G4double outerCase_y = 0. *CLHEP::mm;
  ...
  G4double sensitiveVol_x = 0. *CLHEP::mm;
  G4double sensitiveVol_y = 0. *CLHEP::mm;
...
//     new G4SubtractionSolid("Box-Cylinder", box, cyl);
  ...
  G4double innerCase_x = 0. *CLHEP::mm;
  G4double innerCase_y = 0. *CLHEP::mm;
 ...
 //------------------------------------
  ...
  G4double frontSiPos_x1 = 0.*CLHEP::m;
  G4double frontSiPos_y1 = 0.*CLHEP::m;
  G4double frontSiPos_z1 = tube6Height + 2*(tube5Height + tube4Height + tube3Height  + tube2Height + tube1Height + BeHeight + backAirHeight + backSiHeight + frontAirHeight)  + frontSiHeight+ (6 *CLHEP::mm)+(5*space)+(tube6Height - 0.5*DetHeight);
  ...
  G4double backSiPos_x1 = 0.*CLHEP::m;
  G4double backSiPos_y1 = 0.*CLHEP::m;
  G4double backSiPos_z1 =  tube6Height + 2*( tube5Height + tube4Height  + tube3Height + tube2Height + tube1Height + BeHeight + backAirHeight) + backSiHeight + (6. *CLHEP::mm)+(5*space) + (tube6Height - 0.5*DetHeight);
  ...
  G4double windowPos_x1 = 0.*CLHEP::mm;
  G4double windowPos_y1 = 0.*CLHEP::mm;
  G4double windowPos_z1 = tube6Height + 2*(tube5Height + tube4Height + tube3Height  + tube2Height + tube1Height) + BeHeight + (6.*CLHEP::mm)+(5*space) + (tube6Height - 0.5*DetHeight);
  ...
  G4double trackerPos_x1 = 0.*CLHEP::mm;
  G4double trackerPos_y1 = 0.*CLHEP::mm;
  ...
  //Ceramic cladding:
  G4Tubs* cladding1 = new G4Tubs("cladding1", 13 *CLHEP::mm,16 *CLHEP::mm, tube1Height, 0. *CLHEP::deg, 360. *CLHEP::deg);
  ...
  G4double trackerPos_x2 = 0. *CLHEP::mm;
  G4double trackerPos_y2 = 0.*CLHEP::mm;
  ...
  //Ceramic cladding:
  G4Tubs* cladding2 = new G4Tubs("cladding2", 17 *CLHEP::mm,20 *CLHEP::mm, tube2Height, 0. *CLHEP::deg, 360. *CLHEP::deg);
  ...
  G4double trackerPos_x3 = 0. *CLHEP::mm;
  G4double trackerPos_y3 = 0.*CLHEP::mm;
  ...
  //Ceramic cladding:
  G4Tubs* cladding3 = new G4Tubs("cladding3", 21 *CLHEP::mm, 24.25 *CLHEP::mm, tube3Height, 0. *CLHEP::deg, 360. *CLHEP::deg);
  ...
  G4double trackerPos_x4 = 0. *CLHEP::mm;
  G4double trackerPos_y4 = 0.*CLHEP::mm;
  ...
  //Ceramic cladding:
  G4Tubs* cladding4 = new G4Tubs("cladding4", 26 *CLHEP::mm, 29.25 *CLHEP::mm, tube4Height, 0. *CLHEP::deg, 360. *CLHEP::deg);
  ...
  G4double trackerPos_x5 = 0. *CLHEP::mm;
  G4double trackerPos_y5 = 0.*CLHEP::mm;
  ...
  //Ceramic cladding:
  G4Tubs* cladding5 = new G4Tubs("cladding5", 30 *CLHEP::mm, 33.5 *CLHEP::mm, tube5Height, 0. *CLHEP::deg, 360. *CLHEP::deg);
  ...
  G4double trackerPos_x6 = 0. *CLHEP::mm;
  G4double trackerPos_y6 = 0.*CLHEP::mm;
 ...
 //Ceramic cladding:
  G4Tubs* cladding6 = new G4Tubs("cladding6", 35 *CLHEP::mm,38.25 *CLHEP::mm, tube6Height, 0. *CLHEP::deg, 360. *CLHEP::deg);
