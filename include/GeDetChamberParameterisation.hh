...
#ifndef GeDetChamberParameterisation_H
#define GeDetChamberParameterisation_H 1
...
class GeDetChamberParameterisation : public G4VPVParameterisation
{ 
  public:
  
    GeDetChamberParameterisation(G4int    NoChambers, 
                                 G4double startZ, 
                                 G4double spacing,
